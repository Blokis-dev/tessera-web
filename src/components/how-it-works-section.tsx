...
const steps = [
	{
		...
		description:
			"Carga el certificado que deseas validar en nuestra plataforma segura.",
	},
	{
		icon: Shield,
		title: "2. Procesamiento Seguro",
		description:
			"Nuestro sistema analiza y verifica la autenticidad usando tecnología blockchain.",
	},
	{
		icon: CheckCircle,
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center space-y-4 mb-16">
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
						Un proceso simple y seguro en 4 pasos para validar cualquier
						certificado
					</p>
				</div>
